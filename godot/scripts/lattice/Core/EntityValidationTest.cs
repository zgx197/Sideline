...
namespace Lattice.Core
{
    ...
    public static class EntityValidationTest
    {
        ...
        private static void Test_VersionIncrement()
        {
            ...
            // 销�?            registry.DestroyImmediate(e1);
            ...
            Console.WriteLine("  �?Old EntityRef reference correctly invalidated");
        }
        ...
        private static void Test_ReuseDetection()
        {
            ...
            // 销毁并复用10�?            EntityRef current = original;
            for (int i = 0; i < 10; i++)
            {
            ...
            // 验证原始引用已失�?            Debug.Assert(!registry.IsValid(original), "Original reference should be invalid");
        }
        ...
        private static void Test_BatchOperations()
        {
            ...
            // 批量销�?            var cmd = new CommandBuffer(registry);
        ...
        private static void Test_BoundaryCheck()
        {
            ...
            // 测试非活跃实�?            registry.DestroyImmediate(e);
            ...
            Console.WriteLine("  �?Destroyed EntityRef correctly invalidated");
        }
