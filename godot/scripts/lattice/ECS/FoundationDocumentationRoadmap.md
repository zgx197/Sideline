...
|------|------|----------|----------|-----------|
| P0 | 总体分层与依赖方向 | `ECS/Architecture.md` | 已存在，但范围过大 | 先统一边界，避免后续每份文档口径不一致 |
| P1 | Component 模型与注册体系 | `ECS/ComponentDesign.md` | 缺失 | 所有存储、查询、回放、快照都依赖组件身份 |
...
1. 收敛 `Architecture.md`
2. 新建 `ComponentDesign.md`
3. 新建 `FrameStorageDesign.md`
4. 新建 `QueryDesign.md`
5. 新建 `CommandBufferDesign.md`
6. 回收并继续整理 `SystemDesign.md`
7. 新建 `SimulationSessionDesign.md`
8. 新建 `DeterministicLoopDesign.md`
